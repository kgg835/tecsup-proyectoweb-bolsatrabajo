		...
		<table width="100%">
			<tr>
				<td style="width: 246px" width="246">
					...
					<!-- <img src="/BolsaTrabajoWeb/bootstrap/img/logo.jpg" width="307" height="40"></td> -->
	...
	<div class="row"> 
		...
		<div class="span4" >
			<form class="well" action="insertarUsuario.html" method="post">
	    		...
	    		<input type="text" class="span3" placeholder="Escribe algo?" name="txtNuevoUsuario"><br/>
	    		<label>Contraseña</label>
	    		<input type="password" class="span3" placeholder="Escribe contraseña" name="txtNuevaContrasena"><br/>
	    		<label>Vuelve a escribir tu Contraseña</label>
	    		<input type="password" class="span3" placeholder="Escribe contraseña" name="txtNuevaContrasenavalidar"><br/>
