...
CREATE  TABLE IF NOT EXISTS `bd_bolsatrabajo`.`PERSONA` (
  ...
  PRIMARY KEY (`idPERSONA`, `PER_idPREFERENCIAS_SALARIALES`, `PER_idPRESENTACION`) ,
  INDEX `fk_PERSONA_PREFERENCIAS_SALARIALE1` (`PER_idPREFERENCIAS_SALARIALES` ASC) ,
  INDEX `fk_PERSONA_PRESENTACION1` (`PER_idPRESENTACION` ASC) ,
  ...
  CONSTRAINT `fk_PERSONA_PRESENTACION1`
    FOREIGN KEY (`PER_idPRESENTACION` )
