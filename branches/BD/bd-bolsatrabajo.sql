...
CREATE  TABLE IF NOT EXISTS `bd_bolsatrabajo`.`estudio` (
  ...
  PRIMARY KEY (`idESTUDIO`, `EST_idPERSONA`, `persona_idPERSONA`, `persona_PER_idPRESENTACION`, `persona_PER_idPREFERENCIAS_SALARIALES`) ,
...
CREATE  TABLE IF NOT EXISTS `bd_bolsatrabajo`.`experiencia_laboral` (
  ...
  `persona_PER_idPRESENTACION` INT(11) NOT NULL ,
  `persona_PER_idPREFERENCIAS_SALARIALES` INT(11) NOT NULL ,
  PRIMARY KEY (`idEXPERIENCIA_LABORAL`, `EX_LAB_idPERSONA`, `persona_idPERSONA`, `persona_PER_idPRESENTACION`, `persona_PER_idPREFERENCIAS_SALARIALES`) ,
...
CREATE  TABLE IF NOT EXISTS `bd_bolsatrabajo`.`presentacion` (
  ...
  `persona_PER_idPRESENTACION` INT(11) NOT NULL ,
  `persona_PER_idPREFERENCIAS_SALARIALES` INT(11) NOT NULL ,
  PRIMARY KEY (`idPRESENTACION`, `persona_idPERSONA`, `persona_PER_idPRESENTACION`, `persona_PER_idPREFERENCIAS_SALARIALES`) ,
  INDEX `fk_presentacion_persona1` (`persona_idPERSONA` ASC, `persona_PER_idPRESENTACION` ASC, `persona_PER_idPREFERENCIAS_SALARIALES` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `bd_bolsatrabajo`.`referencia` (
  ...
  `persona_PER_idPRESENTACION` INT(11) NOT NULL ,
  `persona_PER_idPREFERENCIAS_SALARIALES` INT(11) NOT NULL ,
  PRIMARY KEY (`idREFERENCIA`, `REF_idPERSONA`, `persona_idPERSONA`, `persona_PER_idPRESENTACION`, `persona_PER_idPREFERENCIAS_SALARIALES`) ,
