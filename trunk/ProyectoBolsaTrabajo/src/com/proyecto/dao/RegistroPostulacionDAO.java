...
//	public RegistroPostulacion obtenerPostulaciones( int idPostulacion) throws DAOExcepcion {
//	RegistroPostulacion vo = new RegistroPostulacion();
//	Connection con = null;
//	PreparedStatement stmt = null;
//	ResultSet rs = null;
//	try {
//		String query ="Select o.descempresa,a.tituloAviso,a.fechapublicacion,r.fechpostulacion " +
//				" from ofertante o , aviso a , registropostulacion r " +
//				" r.idpersona='" + idPostulacion + "' order by r.idpostulacion asc";
//		
//		con = ConexionBD.obtenerConexion();
//		stmt = con.prepareStatement(query);
...
//				Aviso av = new Aviso();
//				
//				av.setTitulo(rs.getString("tituloAviso"));
//			    av.setFec_publicacion(rs.getDate("fechaPublicacion"));
//				
//			    Ofertante of=new Ofertante();
//			    of.setDescempresa(rs.getString("descempresa"));
//			    
//			    
//			    
//			    vo.s
