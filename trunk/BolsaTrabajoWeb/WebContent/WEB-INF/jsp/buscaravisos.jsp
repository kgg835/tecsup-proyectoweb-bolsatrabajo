...
<div class="avisos-list ">
                    ...
                    <a href="mostrar_aviso.html?idaviso=<% out.print(avi.getIdAviso()); %>" target="_blank" method=post class="aviso_box aviso_listado " title="Gerente de Estaciones Biológicas">
